...
const Promotions = () => {
    ...
    // Lấy sản phẩm khuyến mãi từ API
    useEffect(() => {
    ...
    // Tối ưu hóa danh sách sản phẩm khuyến mãi
    const optimizedPromotionProducts = useMemo(() => promotionProducts, [promotionProducts]);

    if (loading) {
        return (
            <div className="w-full py-24 bg-gradient-to-br from-slate-50 via-orange-50 to-amber-50 flex items-center justify-center">
                <motion.div
        ...
        return (
            <div className="w-full py-24 bg-gradient-to-br from-slate-50 via-orange-50 to-amber-50 flex items-center justify-center">
                ...
                >
                    ...
                    <button
                        onClick={() => fetchPromotionProducts()}
    ...
    return (
        ...
        >
            <div className="w-[96%] mx-auto px-4">
                ...
                {optimizedPromotionProducts.length === 0 ? (
                    <div className="text-center py-16">
                        <div className="w-24 h-24 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-6">
                            <ShoppingCart className="w-12 h-12 text-gray-400" />
                        </div>
                        <p className="text-gray-500 text-lg">Không có chương trình khuyến mãi nào hiện tại.</p>
                        <Link
                            to="/menu"
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        {optimizedPromotionProducts.map((product) => (
                            <motion.div
                                key={product.id}
