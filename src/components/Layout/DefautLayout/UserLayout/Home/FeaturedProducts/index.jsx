...
const FeaturedProducts = () => {
        ...
        const fetchFeaturedProducts = async () => {
            try {
                ...
                if (err.response?.status === 401) {
                    setError('Vui lòng đăng nhập để xem sản phẩm nổi bật.');
                    navigate('/login');
                } else {
                    setError('Không thể tải danh sách sản phẩm nối bật. Vui lòng thử lại sau.');
    ...
    // Tối ưu fined danh sách sản phẩm nổi bật
    const optimizedFeaturedProducts = useMemo(() => featuredProducts, [featuredProducts]);
